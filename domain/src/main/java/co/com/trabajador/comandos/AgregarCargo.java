        ...
        public class AgregarCargo extends Command {
            ...
            /**
             * Constructor de la clase que crea una instancia de Agregar Cargo
             * @param idTrabajador
             * @param idCargo
             * @param nombreCargo
             */
            public AgregarCargo(IdTrabajador idTrabajador,IdCargo idCargo, NombreCargo nombreCargo) {
